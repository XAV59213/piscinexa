...
async def async_setup(hass: HomeAssistant, config: dict) -> bool:
    ...
    input_numbers = [
        ("input_number.piscine_ph_current", {"name": "pH Actuel Piscine", "min": 0, "max": 14, "step": 0.1, "initial": 7.0}),
        ("input_number.piscine_ph_target", {"name": "pH Cible Piscine", "min": 0, "max": 14, "step": 0.1, "initial": 7.4}),
        ("input_number.piscine_chlore_current", {"name": "Chlore Actuel Piscine", "min": 0, "max": 10, "step": 0.1, "unit_of_measurement": "mg/L", "initial": 1.0}),
        ("input_number.piscine_chlore_target", {"name": "Chlore Cible Piscine", "min": 0, "max": 10, "step": 0.1, "unit_of_measurement": "mg/L", "initial": 2.0}),
        ("input_number.spa_ph_current", {"name": "pH Actuel Spa", "min": 0, "max": 14, "step": 0.1, "initial": 7.0}),
        ("input_number.spa_ph_target", {"name": "pH Cible Spa", "min": 0, "max": 14, "step": 0.1, "initial": 7.4}),
        ("input_number.spa_chlore_current", {"name": "Chlore Actuel Spa", "min": 0, "max": 10, "step": 0.1, "unit_of_measurement": "mg/L", "initial": 1.0}),
        ("input_number.spa_chlore_target", {"name": "Chlore Cible Spa", "min": 0, "max": 10, "step": 0.1, "unit_of_measurement": "mg/L", "initial": 2.0}),
        ("input_number.piscine_test_ph_current", {"name": "pH Actuel Piscine Test", "min": 0, "max": 14, "step": 0.1, "initial": 7.0}),
        ("input_number.piscine_test_ph_target", {"name": "pH Cible Piscine Test", "min": 0, "max": 14, "step": 0.1, "initial": 7.4}),
        ("input_number.piscine_test_chlore_current", {"name": "Chlore Actuel Piscine Test", "min": 0, "max": 10, "step": 0.1, "unit_of_measurement": "mg/L", "initial": 1.0}),
        ("input_number.piscine_test_chlore_target", {"name": "Chlore Cible Piscine Test", "min": 0, "max": 10, "step": 0.1, "unit_of_measurement": "mg/L", "initial": 2.0}),
    ]
    ...
    for entity_id, config in input_selects:
        if not hass.states.get(entity_id):
            if isinstance(config, list):
                hass.states.async_set(entity_id, config[0], {
                    "options": config,
                    "name": entity_id.split(".")[1].replace("_", " ").title()
                })
            else:
                hass.states.async_set(entity_id, config["initial"], config)
